...
class Guru extends CI_Controller
{
    ...
    {
        $this->load->view('template/header-guru');
    ...
    public function kelas_siswa($id_kelas)
    {
        ...
        $this->load->view('template/header-guru');
        $this->load->view('guru/kelas_siswa', $data);
        $this->load->view('template/footer');
    }
    ...
    public function prestasi_siswa($id_siswa)
    {
        ...
        $this->load->view('template/header-guru');
        $this->load->view('guru/prestasi_siswa', $data);
        $this->load->view('template/footer');
    }
    ...
    public function prestasi_detail($id_prestasi)
    {
        ...
        $this->load->view('template/header-guru');
        $this->load->view('guru/prestasi_detail', $data);
        $this->load->view('template/footer');
    }
    ...
    public function prestasi_tambah($id_siswa)
    {
        ...
        $this->load->view('template/header-guru');
        $this->load->view('guru/prestasi_tambah', $data);
        $this->load->view('template/footer');
    }
    ...
    public function prestasi_tambah_up()
    {
        ...
        if (!$this->upload->do_upload('photo_prestasi')) {
            ...
            redirect('Guru/siswa_detail/' . $id_siswa);
        }
    }
    ...
    public function prestasi_edit($id_prestasi)
    {
        ...
        $this->load->view('template/header-guru');
        $this->load->view('Guru/prestasi_edit', $data);
        $this->load->view('template/footer');
    }
    ...
    public function prestasi_edit_up()
    {
        ...
        redirect('Guru/prestasi_detail/' . $id_prestasi);
    }
    ...
    public function point()
    {
        ...
        $this->load->view('template/header-guru');
        $this->load->view('guru/point', $data);
        $this->load->view('template/footer');
    }
    ...
    {
        $this->load->view('template/header-guru');
        $this->load->view('guru/point_tambah');
        $this->load->view('template/footer');
    }
    ...
    public function point_edit($id_point)
    {
        ...
        $this->load->view('guru/point_edit', $data);
        $this->load->view('template/footer');
    }
    ...
    public function pelanggaran_detail($id_pelanggaran)
    {
        ...
        $this->load->view('template/header-guru');
        $this->load->view('guru/pelanggaran_detail', $data);
        $this->load->view('template/footer');
    }
    ...
    public function pelanggaran_siswa($id_siswa)
    {
        ...
        $this->load->view('template/header-guru');
        $this->load->view('guru/pelanggaran_siswa', $data);
        $this->load->view('template/footer');
    }
    ...
    public function pelanggaran_tambah($id_siswa)
    {
        ...
        $this->load->view('template/header-guru');
        $this->load->view('guru/pelanggaran_tambah', $data);
        $this->load->view('template/footer');
    }
    ...
    public function password_up()
    {
        ...
        redirect('Guru/password/' . $id_admin);
    }
