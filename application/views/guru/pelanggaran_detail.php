                    ...
                    <div class="card-body">
                        ...
                        ?>
                            ...
                            <div class="text-xs-right">
                                <a href="<?= site_url('Guru/pelanggaran_edit/' . $row->id_pelanggaran) ?>" class="btn btn-sm btn-info">Edit</a>
                                <a href="<?= base_url() ?>Guru/pelanggaran" class="btn btn-sm btn-inverse">Kembali</a>
                            </div>
                        <?php } ?>
                        </form>
                    </div>
