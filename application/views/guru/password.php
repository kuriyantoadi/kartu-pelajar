<div class="page-wrapper">
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor">Halaman Guru</h3>
        </div>
    </div>
                            ...
                            <form class="m-t-40" novalidate>
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <small>Username hanya bisa diganti oleh Admin</small></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <small>Status hanya bisa diganti oleh Admin</small></span>
                                    </div>
                                </div>
                                <div class="form-group">
