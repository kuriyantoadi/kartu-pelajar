                        ...
                        ?>
                            <tr>
                                ...
                                <td style="white-space: nowrap;">
                                    <a class="btn btn-sm btn-rounded btn-danger" href="<?= site_url('Walas/pelanggaran_hapus/' . $row->id_pelanggaran) ?>" onclick="return confirm('Anda yakin menghapus siswa <?= $row->nama_siswa ?> dengan pelanggaran <?= $row->nama_point ?> ?')"><i class="fa fa-times"></i></a>
                                    <a class="btn btn-sm btn-rounded btn-warning" href="<?= site_url('Walas/pelanggaran_edit/' . $row->id_pelanggaran) ?>"><i class="fa fa-pencil"></i></a>
