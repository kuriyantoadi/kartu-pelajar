            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?=
                        form_open_multipart('Admin/siswa_photo_up');
                            ...
                            <form class="m-t-40" novalidate>
                                ...
                                <div class=" form-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <?php } else { ?>
                                            <a href="<?= base_url() ?>Admin/siswa_hapus_photo/<?= $row->id_siswa ?>/<?= $row->photo_siswa ?>" class="btn btn-danger btn-sm" style="margin-bottom: 15px;" onclick="return confirm('Apakah yakin ingin menghapus photo ini?')">Hapus Photo</a><br>
