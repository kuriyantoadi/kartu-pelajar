                            ...
                            <?php foreach ($siswa_detail as $row) { ?>
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="<?= site_url('Guru_bk/prestasi_siswa/' . $row->id_siswa) ?>">Lihat Prestasi</a>
                                        <a class="dropdown-item" href="<?= site_url('Guru_bk/prestasi_tambah/' . $row->id_siswa) ?>">Tambah Prestasi</a>
                                    </div>
                                </div>
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="<?= site_url('Guru_bk/pelanggaran_siswa/' . $row->id_siswa) ?>">Siswa Pelanggaran</a>
                                        <a class="dropdown-item" href="<?= site_url('Guru_bk/pelanggaran_tambah/' . $row->id_siswa) ?>">Tambah Pelanggaran</a>
                                    </div>
                                </div>
